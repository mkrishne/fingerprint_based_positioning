...
%nitialize infinite distance to ensure second condition inside for loop is satisfied at start
...
for AP_idx = 1:L
    ...
    %min distance between UE and AP is to ensure the UE always stays in the Fraunhofer region of the AP
    %min distance between APs is to ensure the shadowing of any two APs are uncorrelated
